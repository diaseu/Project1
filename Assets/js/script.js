...
function getSpoon() {
  axios.get(`https://api.spoonacular.com/recipes/complexSearch?query=${cuisine}&apiKey=83d4060c769f4abcb43ce4f007439a58`)
    .then(({ data }) => {
      console.log(data)
      for (let i = 0; i < 5; i++) {
        let recId = data.results[i].id
        axios.get(`https://api.spoonacular.com/recipes/${recId}/information?apiKey=83d4060c769f4abcb43ce4f007439a58&includeNutrition=true`)
          .then(res => {
